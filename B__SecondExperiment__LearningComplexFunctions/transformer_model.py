...
class TransformerModel(nn.Module):
    def __init__(self, attention_class, depth, input_dim, embedding_dim):
        ...
        self.layers_lst_2 = \
            [self.attention_factory(attention_class,
    ...
    def attention_factory(self, attention_class, input_dim, embedding_dim):
        if attention_class == 'Attention2':
            attention = Attention2(input_dim, embedding_dim)
        elif attention_class == 'Attention3':
            attention = Attention3(input_dim, embedding_dim)
    ...
    def shaper(self, batch):
        # TODO All this method should be changed !
        with_embed = batch.unsqueeze(-1)

...
class DegreeNetworksFactory:
    def __init__(self, budget, input_dim, embedding_dim):
        super(DegreeNetworksFactory, self).__init__()
        self.budget = budget
    ...
    def models_list(self):
        models_list_ = [self.transformer_4, self.transformer_3, self.transformer_2]
        return models_list_
